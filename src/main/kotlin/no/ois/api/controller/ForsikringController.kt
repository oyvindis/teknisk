...
class ForsikringController(
    ...
    fun opprettForsikring(
        ...
        val avtaleResponseDTO = fagsystemServiceClient.opprettAvtale(kundeResponseDTO.kundenummer)

        val brevtjenesteResponseDTO = brevtjenesteServiceClient.sendAvtale(avtaleResponseDTO.avtalenummer)

        return ResponseEntity
            .created(uriComponentsBuilder.path("/forsikring/opprette").build().toUri())
